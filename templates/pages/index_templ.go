...
func BodyScripts() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_BodyScripts_e64f`,
		Function: `function __templ_BodyScripts_e64f(){console.log(
		"Bajro",

	);
}`,
		Call:       templ.SafeScript(`__templ_BodyScripts_e64f`),
		CallInline: templ.SafeScriptInline(`__templ_BodyScripts_e64f`),
	}
}
